...
public:
    ...
    // KARNA KYA HAIN❓
    // 1. Oindexed m*n matrix diya hain , where no 2 adjacent cells are equal.
    // 2. We have to find peak element in this matrix and return its row and col.
    // 3. Peak elem is the elem which is strictly greater than top,down,left,right.
    // 4. Entire perimater us surrounded by -1.
